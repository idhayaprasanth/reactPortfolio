    ...
    <div className="relative overflow-hidden">
      ...
      <div className="cpu-container">
        ...
        {showIP && (
          <div className="voice">
            <img
              src={isVoicePlaying ? voice : voiceimg} // This toggles between two images
              alt="Voice"
              className="voice-img" // Make sure you target this for styling
            />
          </div>
        )}
...
.voice-img {
  max-width: 200px; /* Ensure it's not too large to overflow */
  max-height: 200px;
}
